...
def save_features(model, data_loader, outfile ):
    ...
    f.close()
    print("\n h5py file written directory below \n {}".format(outfile))
...
if __name__ == '__main__':
    ...
    print(" this is save_feature.py file","\n")
    print(" LINE 74 CHECKPOINT DIRECOTRY needs to be checked","\n")
    checkpoint_dir = "/content/gdrive/MyDrive/Colab Notebooks/FSL_Relationnet_custom_data/checkpoints/custom/Conv4_relationnet"
    ...
    if params.save_iter != -1:
        outfile = os.path.join( checkpoint_dir + str(params.save_iter) + ".hdf5") 
    else:
        outfile = os.path.join( checkpoint_dir + str(params.save_iter) + ".hdf5")
